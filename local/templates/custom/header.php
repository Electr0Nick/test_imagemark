...
<body>
  ...
  <header class="header">
    <div class="header__row header__row_top"></div>
    <div class="header__row header__row_center"></div>
    <div class="header__row header__row_bottom"></div>
  </header>
      ...
      <table id="logo">
        <tr>
          <td><a href="<?= SITE_DIR ?>" title="<?= GetMessage('CFT_MAIN') ?>">
              <? $APPLICATION->IncludeFile(SITE_DIR . "include/company_name.php", array(), array("MODE" => "html")); ?>
            </a></td>
        </tr>
      </table>
